...
if __name__ == '__main__':
    ...
    brightened_im = brighten(lake, 4.7)
    brightened_im.write_image('brightened.png')

    darkened_im = brighten(lake, 0.3)
    darkened_im.write_image('darkened.png')

    incr_contrast = adjust_contrast(lake, 1.4, 0.5)
    ...
    blur_15 = blur(city, 10)
    blur_15.write_image('blur_k15.png')
    sobel_x = apply_kernel(city, np.array([[2, 2,2], [0, 0, 0], [-1, -2, -1]]))
    sobel_x.write_image('edge_x.png')
    sobel_y = apply_kernel(city, np.array([[2, 0, -1], [1, 0, -1], [2, 0, -1]]))
